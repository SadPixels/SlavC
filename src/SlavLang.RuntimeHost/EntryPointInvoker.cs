...
public static class EntryPointInvoker
{
    public static async Task<int> InvokeAsync(Assembly assembly, string[] args)
    {
        var entryPoint = assembly.EntryPoint ??
            throw new InvalidOperationException("SLAVH1004: Entry assembly has no entry point.");
        ...
        object?[]? invocationArguments = parameters.Length switch
        {
            ...
            _ => throw new InvalidOperationException(
                $"SLAVH1005: Unsupported entry point signature '{entryPoint}'."),
        };
        ...
        return result switch
        {
            ...
            _ => throw new InvalidOperationException(
                $"SLAVH1006: Unsupported entry point return type '{entryPoint.ReturnType}'."),
        };
    }
