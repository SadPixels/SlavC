...
SlavLang source is translated to C#, compiled in memory against a bundled reference
pack, and written into SlavPack with a RID-specific self-contained RuntimeHost.
